  ...
  function createSecretShare(jiff, share) {
    ...
    self.sadd = function(o) {
      ...
      var ready_add = function() {
        if (self.value !== null && o.value === null){
          console.log("branch 1")
          return self.jiff.helpers.mod(self.value, self.Zp);
        }
        else if (self.value === null && o.value !== null){
          console.log("branch 2")
          return o.value;
        }
        else if (self.value === null && o.value === null){
          throw "Null value for one or more shares"
        }
        else {
